          ...
          <View style={{ flexDirection: "column", gap: 24 }}>
            <View style={{ flexDirection: "column", gap: 16 }}>
              ...
              <Text style={styles.text}>
                Source Location: Malang, Indonesia
              </Text>
            </View>
            <View
              style={{
        ...
        >
          <View style={{ flexDirection: "column", gap: 16 }}>
            <Text style={styles.text}>
              ...
              Saturday, heavy rainfall is expected to lower water quality,
              making it unsafe for direct use. Be sure to filter or boil water
              before consuming.
            </Text>
